...
export default function FloatingButtons() {
  ...
  const handleInstall = async () => {
    ...
    if (deferredPrompt) {
      ...
      // Show iOS instructions as fallback for other browsers
      setShowIOSInstructions(true);
    }
  };
  ...
  return (
    <>
      ...
      {showIOSInstructions && (
        ...
        >
          <div
            className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full p-6 transform animate-scale-in"
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                <div className="flex-shrink-0 w-8 h-8 bg-revolution-green text-white rounded-full flex items-center justify-center font-bold text-sm">
                  1
                </div>
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
              ...
              <div className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-2 text-gray-500 dark:text-gray-400 text-sm">
                    ...
                    <span>سيظهر التطبيق على شاشتك</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Note */}
            <div className="mt-6 p-4 bg-revolution-green/10 border border-revolution-green/20 rounded-xl">
              <p className="text-sm text-gray-600 dark:text-gray-400 flex items-start gap-2">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="text-revolution-green flex-shrink-0 mt-0.5"
                >
                ...
                <span>
                  يجب استخدام متصفح <strong>Safari</strong> لتثبيت التطبيق على
                  الآيفون
                </span>
              </p>
            </div>
            ...
            <button
              type="button"
              onClick={() => setShowIOSInstructions(false)}
              className="mt-6 w-full py-3 px-4 bg-revolution-green hover:bg-revolution-green/90 text-white font-medium rounded-xl transition-colors"
            >
              فهمت
            </button>
          </div>
